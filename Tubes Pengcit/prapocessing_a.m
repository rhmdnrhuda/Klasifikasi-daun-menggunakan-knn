...
sa1 = regionprops(reA1, 'Area','MajorAxisLength','MinorAxisLength','Eccentricity','Orientation','ConvexArea','FilledArea','EulerNumber','EquivDiameter','Solidity','Extent','Perimeter','PerimeterOld')
sa2 = regionprops(reA2, 'Area','MajorAxisLength','MinorAxisLength','Eccentricity','Orientation','ConvexArea','FilledArea','EulerNumber','EquivDiameter','Solidity','Extent','Perimeter','PerimeterOld')
sa3 = regionprops(reA3, 'Area','MajorAxisLength','MinorAxisLength','Eccentricity','Orientation','ConvexArea','FilledArea','EulerNumber','EquivDiameter','Solidity','Extent','Perimeter','PerimeterOld')
sa4 = regionprops(reA4, 'Area','MajorAxisLength','MinorAxisLength','Eccentricity','Orientation','ConvexArea','FilledArea','EulerNumber','EquivDiameter','Solidity','Extent','Perimeter','PerimeterOld')
sa5 = regionprops(reA5, 'Area','MajorAxisLength','MinorAxisLength','Eccentricity','Orientation','ConvexArea','FilledArea','EulerNumber','EquivDiameter','Solidity','Extent','Perimeter','PerimeterOld')
aa = cell2mat(struct2cell(sa1));
aa(1);
ab = struct2table(sa2);
ac = struct2table(sa3);
ad = struct2table(sa4);
ae = struct2table(sa5);
filename = 'test.xlsx';
writetable(aa,filename,'Sheet',1,'Range','A1');
writetable(ab,filename,'Sheet',1,'Range','A7');
writetable(ac,filename,'Sheet',1,'Range','A13')
writetable(ad,filename,'Sheet',1,'Range','A19')
writetable(ae,filename,'Sheet',1,'Range','A26')
